...
<html lang="en">
  ...
  <body>
      ...
      <div class="sidebar-header border-bottom">
        <div class="sidebar-brand">
          <svg class="sidebar-brand-full" width="88" height="32" alt="CoreUI Logo">
            <use xlink:href="<?php echo $theme_assets . 'assets/brand/coreui.svg#full' ?>"></use>
          </svg>
          <svg class="sidebar-brand-narrow" width="32" height="32" alt="CoreUI Logo">
            <use xlink:href="<?php echo $theme_assets . 'assets/brand/coreui.svg#signet' ?>"></use>
          </svg>
        </div>
    ...
    <script src="<?php echo $theme_assets . 'vendors/@coreui/chartjs/js/coreui-chartjs.js' ?>"></script>
    <script src="<?php echo $theme_assets . 'vendors/@coreui/utils/js/index.js' ?>"></script>
